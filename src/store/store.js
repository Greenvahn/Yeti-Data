...
export const store = new Vuex.Store({
    state: {
        ...
        mainText: [
            {
                content: [
                    {
                        p: 'A single-page application to display your data',
                        class: 'title align-center'
                    },
                    {
                        p: 'A quick way to turn CSV files into charts without any installation.',
                        class: 'align-center'
                    }
                ],
                type: 'introduction'
            },
            {
                content: [
                    ...
                    {
                        p: 'A comma-separated values (CSV) file is a file format that uses commas to separate individual values and allows to save data in a tabular format. You can check if your file is in the correct format by looking for the \'.csv\' extension following the file name.',
                        class: ''
                    }
                ],
                type: 'information'
            },
            {
                content: [
                    ...
                    {
                        p: 'CSV files can be read and generated by almost any spreadsheet programme, such as Microsoft Excel or Google Spreadsheets. They differ from other spreadsheet file types because you can only have a single sheet in a file. To create a CSV file, open your data in the tool of your choice and save it as \'.csv\' file. It is also possible to generate your CSV manually for small data files.',
                        class: ''
                    }
                ],
            ...
            },
            {
                content: [
                    {
                        p: 'You can always use our sample CSV file to check out this tool. The download will start as soon as you hit the button. Feel free to edit and play with it before uploading it again.',
                        class: ''
                    }
                ],
                buttons: [
        ...
        instructions: {
            main: 'Start by selecting and uploading your CSV file. Then press the "launch" button to display the data.',
            button: 'launch'
        },
        inputOptions: [
            {
        ...
        buttons: {
            ...
            columnSelector: [
                ...
                },
                {
                    id: 'values',
                    class: 'select',
                    text: ' Select values (numbers only)',
                    options: []
                }
            ],
            instructions: [
                {
                    text: 'Select the data you want to visualise. You\'ll need a column for labels and another for values.',
                    class: ''
                },
                {
                    text: 'Hit the button to start.',
                    class: 'bold'
                }
            ]
        },
        messages: [
            {
                ...
                msg: [
                    {
                        p: 'You may want to check your data. There seem to be empty cells.'
                    },
                    {
                        p: 'Ignore this message if your happy with the data.'
                    }
                ],
                buttons: [
                    { txt: 'OK' }
            ...
            },
            {
                ...
                msg: [
                    {
                        p: 'Make sure your data is saved and uploaded as a CSV file.'
                    },
                    {
                        p: 'What is a CSV file?',
                        class: 'p-subtitle'
                    ...
                    {
                        p: 'A comma-separated values (CSV) file is a file format that uses commas to separate individual values and allows to save data in a tabular format.'
                    }
                ],
                buttons: [
                    { txt: 'OK' }
            ...
            },
            {
                ...
                msg: [
                    {
                        p: 'Not all of your cells contain numbers.'
                    },
                    {
                        p: 'Please select a column with numbers only for your \'values\'.'
                    }
                ],
                buttons: [
                    { txt: 'OK' }
